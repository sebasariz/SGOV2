 ...
 */
public class CreateProducto extends org.apache.struts.action.Action {
    ...
    public ActionForward execute(ActionMapping mapping, ActionForm form,
        ...
        if (usuario != null) {
            ...
            producto.setIdEmpresa(usuario.getIdEmpresa());
            //validar el email 
            ProductoMongoController productoMongoController = new ProductoMongoController();
            productoMongoController.createProducto(producto);
