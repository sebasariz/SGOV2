 ...
 */
public class LoadProductoJson extends org.apache.struts.action.Action {
    ...
    public ActionForward execute(ActionMapping mapping, ActionForm form,
        ...
        if (usuario != null) {
            ...
            Producto producto = productoMongoController.findProducto(id);
            jSONObject = new JSONObject(producto);
        } else {
