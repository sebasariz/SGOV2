 ...
 */
public class LoadAsignacionSubmodulos extends org.apache.struts.action.Action {
    ...
    public ActionForward execute(ActionMapping mapping, ActionForm form,
        ...
        if (usuario != null) {
            request.setAttribute("usuarios", GetDynamicTable.getUsersTableSubmodulos(usuario));
            String content = "/pages/administracion/submodulos.jsp"; 
            ...
            CreateLogActividades.createLogActividades(usuario, "Ingresando submodulos a usuarios.", request);
        } else {
