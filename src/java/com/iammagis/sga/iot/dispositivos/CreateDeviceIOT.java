...
public class CreateDeviceIOT extends Action {
   ...
   public ActionForward execute(ActionMapping mapping, ActionForm form, HttpServletRequest request, HttpServletResponse response) throws Exception {
      ...
      if (usuario != null) {
         IOTDevice deviceIOT = (IOTDevice)form;
         IOTDeviceMongoController iOTDeviceMongoController = new IOTDeviceMongoController();
         deviceIOT.setValoresMax(new JSONObject());
         deviceIOT.setValoresMin(new JSONObject());
         deviceIOT.setUltimoValor(new JSONObject());
         iOTDeviceMongoController.createIOTDevice(deviceIOT);
