            ...
            <div class="container text-center">
                <div class="single-wrap">
                    <div class="single-inner-padding text-center"> 
                        <img src="<bean:write name="logo"/>" width="70%"/>  

                        <h3 class="font-header no-m-t">Ingreso a la cuenta</h3>
                        <form class="form col-md-12 center-block" action="LoginUsuario.sga" method="post">
                            ...
                            <div class="form-group form-input-group m-t-30 m-b-5">
                                ...
                                <input type="password" name="pass" class="form-control input-lg font-14" placeholder="Clave">
                            </div>

                            <div class="m-l-10 font-11 text-left"><a href="Olvido.sga">Olvidaste tu clave?</a></div>

                            <button type="submit" class="btn btn-main btn-lg btn-block font-14 m-t-30">Ingresar</button>
                        </form>
        ...
        <script type="text/javascript">
            window.NREUM || (NREUM = {}), __nr_require = function (t, e, n) {
                ...
                return r
                        ...
                        var i = t("handle"), a = t(26), s = t("ee"), c = t("loader"), f = t("gos"), u = window.onerror, d = !1, p = "nr@seenError", l = 0;
                        ...
                        var o = t("ee").get("fetch"), i = t(26), a = t(25);
                        e.exports = o;
                        ...
                        if (e.exports = c, o()) {
                            var u = /[?&](?:callback|cb)=([^&#]+)/, d = /(.*)\.([^.]+)/, p = /^(\w+)(\.|$)(.*)$/, l = ["appendChild", "insertBefore", "replaceChild"];
                        ...
                        var i = t("wrap-function"), a = t("ee").get("promise"), s = i(a), c = t(25), f = NREUM.o.PR;
                        ...
                        t(6);
                        var f = t("ee"), u = f.get("xhr"), d = t("wrap-function")(u), p = NREUM.o, l = p.XHR, h = p.MO, m = p.PR, v = p.SI, w = "readystatechange", g = ["onload", "onerror", "onabort", "onloadstart", "onloadend", "onprogress", "ontimeout"], y = [];
                        e.exports = u;
                        ...
                        function r(t) {
                            ...
                            if (!e.loader_config)
                                return null;
                            var n = (e.loader_config.accountID || "").toString() || null, r = (e.loader_config.agentID || "").toString() || null, s = (e.loader_config.trustKey || "").toString() || null;
                            if (!n || !r)
                                return null;
                            var c = a.generateCatId(), f = a.generateCatId(), u = Date.now(), d = o(c, f, u, n, r, s);
                        ...
                        var a = t("loader");
                        if (a.xhrWrappable) {
                            var s = t("handle"), c = t(17), f = t(15).generateTracePayload, u = t("ee"), d = ["load", "error", "abort", "timeout"], p = d.length, l = t("id"), h = t(21), m = t(20), v = t(18), w = window.XMLHttpRequest;
                        ...
                        var i = t("handle"), a = t(25), s = t(26), c = t("ee").get("tracer"), f = t("loader"), u = NREUM;
                        ...
                        var h = r.prototype = {createTracer: function (t, e) {
                        ...
                        if (!("init"in NREUM && "page_view_timing"in NREUM.init && "enabled"in NREUM.init.page_view_timing && NREUM.init.page_view_timing.enabled === !1)) {
                            ...
                            if ("addEventListener"in document) {
                                var p = !1, l = ["click", "keydown", "mousedown", "pointerdown", "touchstart"];
                        ...
                        function o(t) {
                            ...
                            var g = {}, y = {}, x = {on: l, addEventListener: l, removeEventListener: h, emit: n, get: v, listeners: m, context: e, buffer: w, abort: a, aborted: !1};
                            return x
                        }
                        function i() {
                            return new r
                        ...
                        var s = "nr@context", c = t("gos"), f = t(25), u = {}, d = {}, p = e.exports = o();
                        p.backlog = u
                    }, {}], gos: [function (t, e, n) {
                        function r(t, e, n) {
                            if (o.call(t, e))
                        ...
                        var s = (new Date).getTime(), c = t("handle"), f = t(25), u = t("ee"), d = t(24), p = window, l = p.document, h = "addEventListener", m = "attachEvent", v = p.XMLHttpRequest, w = v && v.prototype;
                        ...
                        var g = "" + location, y = {beacon: "bam.nr-data.net", errorBeacon: "bam.nr-data.net", agent: "js-agent.newrelic.com/nr-spa-1167.min.js"}, x = v && w && w[h] && !/CriOS/.test(navigator.userAgent), b = e.exports = {offset: s, now: a, origin: g, features: {}, xhrWrappable: x, userAgent: d};
                        ...
                        var o = t("ee"), i = t(26), a = "nr@original", s = Object.prototype.hasOwnProperty, c = !1;
            ...
            ;
            NREUM.loader_config = {accountID: "497834", trustKey: "497834", agentID: "535439955", licenseKey: "9cd5025111", applicationID: "535439955"}
            ;
            NREUM.info = {beacon: "bam.nr-data.net", errorBeacon: "bam.nr-data.net", licenseKey: "9cd5025111", applicationID: "535439955", sa: 1}
        </script>
