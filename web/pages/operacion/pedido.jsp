                ...
                <form id="gestion-crear" method="post" enctype="multipart/form-data">
                    <div class="modal-body" >   
                        ...
                        <div class="row" style="margin-top: 10px;">
                            ...
                            <div class="col-lg-12">
                                <textarea name="nota" id="nota-crear" class="form-control" style="min-height: 50px;"></textarea>
                            </div>
                        </div>
            ...
            <div class="modal-content">
                ...
                <form id="gestion_empacados" method="post" enctype="multipart/form-data">
                    <div class="modal-body" >    
                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                <label for="text-input" ><bean:message key="sga.transportadora"/></label> 
                            </div>
                            <div class="col-lg-12">
                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                <label for="text-input" ><bean:message key="sga.notaGuia"/></label> 
                            </div>
                            <div class="col-lg-12">
                                <input type="text" name="notaGuia" id="notaGuia" class="form-control"/>
                            </div>
                        </div>
                        <div class="row"   style="margin-top: 20px;">
                            <div class="col-lg-5">
