...
<html>
                ...
                <form id="gestion-crear" method="post" enctype="multipart/form-data">
                    <div class="modal-body" >   
                        ...
                        <div class="row">    
                            ...
                            <div class="col-lg-2">
                                <input type="text" placeholder="Valor" class="form-control" id="valorCrear">
                            </div>
                            <div class="col-lg-2">
                        ...
                        <div class="row" style="margin-top: 10px;">
                            ...
                            <div class="col-lg-12">
                                <textarea name="nota" class="form-control" style="min-height: 50px;"></textarea>
                            </div>
                        </div>
    ...
    <script src="js-in/operacion/pedidos_eliminados.js"></script>
    <script>
                                    $(function () {
