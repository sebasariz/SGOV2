...
<html>
    ...
    <ol class="breadcrumb">
        ...
        <li><a href="LoadHistorialPorCliente.sga"><bean:message key="sga.empresas"/></a></li> 
    </ol>
        ...
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <h3 class="modal-title">Historial pedidos</h3>
                </div>
    ...
    <script src="js-in/operacion/historialcliente.js"></script>
    <script>
        $(function () {
