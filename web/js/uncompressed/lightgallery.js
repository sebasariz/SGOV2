    ...
    Plugin.prototype.structure = function() {
        ...
        if (this.s.controls && this.$items.length > 1) {
            controls = '<div class="lg-actions">' +
                '<div class="lg-prev lg-icon"><i class="icon-arrow-left2"></i>' + this.s.prevHtml + '</div>' +
                '<div class="lg-next lg-icon">' + this.s.nextHtml + '<i class="icon-arrow-right2"></i></div>' +
                '</div>';
        }
        ...
        template = '<div class="lg-outer ' + this.s.addClass + ' ' + this.s.startClass + '">' +
            ...
            '<span class="lg-close lg-icon"><i class="icon-cross"></i></span>' +
            '</div>' +
            controls +
            subHtmlCont +
            '</div>' +
        ...
        if (this.s.download) {
            this.$outer.find('.lg-toolbar').append('<a id="lg-download" target="_blank" download class="lg-download lg-icon"><i class="icon-download"></i></a>');
        }
